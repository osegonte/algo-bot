...
def main():
    ...
    if args.summary > 0:
        ...
        async def run_daemon():
            print(f"🔄 Starting stability monitoring daemon (interval: {args.interval}s)")
        ...
        print("   Examples:")
        print("   python stability_watch.py --check")
        print("   python stability_watch.py --daemon --interval 60")
        print("   python stability_watch.py --summary 24")
